...
internal enum Asset {
  ...
  internal static let simpleGreenColoredShadow = ImageAsset(name: "simpleGreenColoredShadow")
  internal static let simpleLightLeaf = ImageAsset(name: "simpleLightLeaf")
  internal static let simpleLinedLeaf = ImageAsset(name: "simpleLinedLeaf")
  internal static let simpleRedColoredShadow = ImageAsset(name: "simpleRedColoredShadow")
  internal static let simpleRedLeaf = ImageAsset(name: "simpleRedLeaf")
  internal static let simpleRedLightShadow = ImageAsset(name: "simpleRedLightShadow")
  internal static let simpleYellowColoredShadow = ImageAsset(name: "simpleYellowColoredShadow")
