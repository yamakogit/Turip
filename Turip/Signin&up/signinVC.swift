...
class signinViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        mailTF.tag = 0
        mailTF.addTarget(self, action: #selector(signinViewController.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
        
        passTF.delegate = self
        passTF.tag = 1
        passTF.addTarget(self, action: #selector(signinViewController.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
